...
| Schema-aware validation, semantic diff, and Session Review                   | planned        | Plan 004                                                                                                                     |
| Persistent session lifecycle and safe intents for every row operation        | planned        | Plan 004                                                                                                                     |
...
| Peculiar Sheets editing, row operations, and product interactions            | planned        | Plan 005; no component/product test exists yet                                                                               |
